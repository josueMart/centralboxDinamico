...
function theme_name_scripts() {
    ...
    wp_enqueue_script( 'script-menu-superior', get_template_directory_uri() . '/js/menu.js',  array('jquery'), '1.0.0', true );
    wp_enqueue_script( 'script-menu-category', get_template_directory_uri() . '/js/category-menu.js',  array('jquery'), '1.0.0', true );
    /* wp_enqueue_script( 'script-jquery', get_template_directory_uri() . '/js/jquery.js',  array('jquery'), '1.0.0', true );*/
      wp_enqueue_script( 'script-input', get_template_directory_uri() . '/js/what-input.js',  array('jquery'), '1.0.0', true );
       wp_enqueue_script( 'script-foundation', get_template_directory_uri() . '/js/foundation.js',  array('jquery'), '1.0.0', true );
       wp_enqueue_script( 'script-app', get_template_directory_uri() . '/js/app.js',  array('jquery'), '1.0.0', true );
}
 ...
 function register_my_menus(){
    register_nav_menus(
        ...
        array(
                ...
                'category' => __('Menú de Categorias'),
...
// add main/sub classes to li's and links
 function start_el( &$output, $item, $depth = 0, $args = Array(), $id = 0 ) {
    ...
    $description  = ! empty( $item->description ) ? '<span class="fa '.esc_attr( $item->description ).'"></span>' : '';
